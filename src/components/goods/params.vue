        ...
        <el-card>
            ...
            <el-row class="cat_opt">
                <el-col>
                    <span>选择商品分类：</span>
                    <!-- 选择商品分类的级联选择框 -->
                    <el-cascader expand-triggeer="hover" v-model="selectedCateKeys" :options="catelist"
            ...
            <el-tabs v-model="activeName" @tab-click="handleTabClick">
                <el-tab-pane label="动态参数" name="many">
                    <!-- 添加参数的按钮 -->
                    <el-button type="primary" size="mini" :disabled="isBtnDisabled" @click="addParamsdialog">添加参数
                    </el-button>
                    <!-- 动态参数表格 -->
                    <el-table :data="manyTableData" stripe border>
                        ...
                        <el-table-column type="expand">
                            <template v-slot="scope">
                                <!-- 循环渲染Tag标签 -->
                                <el-tag class="zhankai" v-for="(item, i) in scope.row.attr_vals" :key="i" closable
                ...
                <el-tab-pane label="静态属性" name="only">
                    <!-- 添加属性的按钮 -->
                    <el-button type="primary" size="mini" :disabled="isBtnDisabled" @click="addParamsdialog">添加属性
                    </el-button>
                    <!-- 静态属性参数表格 -->
            ...
            <el-dialog :title="'添加' + titleText" :visible.sync="addParamsdialogVisible" width="50%"
                ...
                <el-form :model="addParmsForm" :rules="addParmsFormRules" ref="addParmsFormRef" label-width="90px">
...
export default {
    ...
    methods: {
        ...
        // 点击按钮，添加参数
        addParams() {
            // console.log(this.addParmsForm);
            this.$refs.addParmsFormRef.validate(async valid => {
                if (!valid) return
                const { data: res } = await this.$http.post(`categories/${this.cateId}/attributes`, {
                    attr_name: this.addParmsForm.attr_name,
